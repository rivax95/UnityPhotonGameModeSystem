...
namespace Invector.vCharacterController
{
    public class vThirdPersonMotor : MonoBehaviour
    {
        ...
        [Tooltip("Use this to rotate the character using the World axis, or false to use the MainCamara_Escene axis - CHECK for Isometric Camera")]
        ...
        internal Transform rotateTarget;                    // used as a generic reference for the MainCamara_Escene.transform
